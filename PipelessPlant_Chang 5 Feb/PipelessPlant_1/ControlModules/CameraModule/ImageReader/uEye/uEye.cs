...
namespace MULTIFORM_PCS.ControlModules.CameraModule.ImageReader.uEyeCam
{
            ...
            unsafe
            {
                fixed (byte* pstrFilename = &byTemp[0])
                {
                    ...
                    if (nRet != IS_SUCCESS)
                    {
                        ...
                        {
                            Console.WriteLine("ERROR: File cannot be loaded. It is probably no bitmap");
                        }
                        else
                        {
                            Console.WriteLine("ERROR: File cannot be loaded");
                        }
                    }
                    return nRet;
                }
